        ...
        <div class="grid grid-cols-1 min-[500px]:grid-cols-2 lg:grid-cols-3 gap-3 mt-8 mb-16">
            <div>
                <div class="bg-gray-200 bg-opacity-40 rounded-lg">
                    <img class="h-40 md:h-52 rounded w-full object-cover object-center mb-6" src="https://dummyimage.com/721x401" alt="content">
                    <div class="px-6 pb-6">
                        <h3 class="tracking-widest text-indigo-400 text-xs font-medium title-font">SUBTITLE</h3>
                        <h2 class="text-lg font-medium title-font mb-4">Colosseum Roma</h2>
